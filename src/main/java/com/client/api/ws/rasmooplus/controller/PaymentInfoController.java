...
public class PaymentInfoController {
    ...
    @PostMapping("/process")
    public ResponseEntity<Boolean> process(@RequestBody PaymentProccessDTO proccessDTO){
        return ResponseEntity.status(HttpStatus.OK).body(paymentInfoService.process(proccessDTO));
    }
}
